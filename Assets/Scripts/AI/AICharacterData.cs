...
public class AICharacterData
{
    ...
    {
        string playerName = "Player"; //todo: добавить имя игрока GameManager.instance.GetPlayerName();
        // �������� �������
    ...
    private async Task<PromptPart> generateFactsPrompt()
    {
        ...
        foreach (var fact in factsAboutPlayer)
        {
